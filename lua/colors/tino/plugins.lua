...
local plugins = {
  ...
  NvimTreeFolderIcon = { fg = colors.neutral_red },
  ...
  -- ["@spell"] = { underline = true },
  	...
  	-- Telescope.nvim
  	TelescopeSelection = { bg = colors.light2, fg = colors.neutral_red, bold = true },
  	TelescopeSlectionCaret = { link = "PmenuSbar" },
  	TelescopeMultiSelection = { reverse = true },
	TelescopeNormal = { bg = colors.light1, fg = colors.black },
  	...
  	TelescopePromptPrefix = { fg = colors.neutral_red, bold = true },
