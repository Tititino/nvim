...
keymap({'t', 'x', 'c', 'n'}, '<leader>-1', ':tabf<cr>', { noremap = true, silent = true })
keymap({'t', 'x', 'c', 'n'}, '<leader>-2', ':tabn2<cr>', { noremap = true, silent = true })
keymap({'t', 'x', 'c', 'n'}, '<leader>-3', ':tabn3<cr>', { noremap = true, silent = true })
keymap({'t', 'x', 'c', 'n'}, '<leader>-4', ':tabn4<cr>', { noremap = true, silent = true })
keymap({'t', 'x', 'c', 'n'}, '<leader>-5', ':tabn5<cr>', { noremap = true, silent = true })
keymap({'t', 'x', 'c', 'n'}, '<leader>-6', ':tabn6<cr>', { noremap = true, silent = true })
keymap({'t', 'x', 'c', 'n'}, '<leader>-7', ':tabn7<cr>', { noremap = true, silent = true })
keymap({'t', 'x', 'c', 'n'}, '<leader>-8', ':tabn8<cr>', { noremap = true, silent = true })
keymap({'t', 'x', 'c', 'n'}, '<leader>-9', ':tabn9<cr>', { noremap = true, silent = true })
keymap({'t', 'x', 'c', 'n'}, '<leader>-0', ':tabl<cr>', { noremap = true, silent = true })
